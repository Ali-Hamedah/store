...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('dashboard.product_categories.index') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('dashboard.product_categories.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
